/*!
 * @pdftron/wavesurfer.js regions plugin 4.2.9 (2021-08-23)
...
var RegionsPlugin = /*#__PURE__*/function () {
  ...
  _createClass(RegionsPlugin, [{
    ...
    value: function enableDragSelection(params) {
      ...
      this.wrapper.addEventListener('touchend', eventUp); // ** CUSTOMIZATION **
      ...
      this.on('disable-drag-selection', function () {
        _this4.wavesurfer.params.doc.body.removeEventListener('mouseup', eventUp);

        _this4.wavesurfer.params.doc.body.removeEventListener('touchend', eventUp);
  ...
  _createClass(Region, [{
    ...
    value: function bindDragEvents() {
      ...
      var onDown = function onDown(e) {
        ...
        startTime = _this4.regionsUtil.getRegionSnapToGridValue(_this4.wavesurfer.drawer.handleEvent(e, true) * duration); // Store the selected point of contact when we begin dragging
      ...
      var onMove = function onMove(e) {
        ...
        if (_this4.scroll && container.clientWidth < _this4.wrapper.scrollWidth) {
          ...
          if (drag) {
            var x = e.clientX; // Check direction
            ...
            var _x = e.clientX; // Check direction
      ...
      this.element.addEventListener('touchstart', onDown); // ** CUSTOMIZATION **
      ...
      this.on('remove', function () {
        _this4.wavesurfer.params.doc.body.removeEventListener('mouseup', onUp);

        _this4.wavesurfer.params.doc.body.removeEventListener('touchend', onUp);

        _this4.wavesurfer.params.doc.body.removeEventListener('mousemove', onMove);

        _this4.wavesurfer.params.doc.body.removeEventListener('touchmove', onMove);
      });
